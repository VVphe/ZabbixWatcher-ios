...
class MenuViewController: UICollectionViewController, ZoomingIconViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.contentInset = UIEdgeInsets(top: 100, left: 35, bottom: 0, right: 35)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAtIndex section: Int) -> UIEdgeInsets {
        ...
        return UIEdgeInsets(top: 100, left: inset, bottom: 40, right: inset)
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let item = data[index]
        let controller = UIStoryboard(name: "KnowMore", bundle: nil).instantiateViewController(withIdentifier: "DetailViewController") as! DetailViewController
